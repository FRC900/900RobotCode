...
/home/ubuntu/900RobotCode/scripts/jetson_setup/wait_for_ssh.sh 10.9.0.9 5801 >> /home/ubuntu/bagfiles/mounted.txt
echo ubuntu | ssh -tt 10.9.0.9 sudo -kS systemctl stop ntp.service
#echo ubuntu | ssh -tt 10.9.0.9 sudo -kS date -s @$(date -u +"%s")
echo ubuntu | ssh -tt 10.9.0.9 sudo -kS ntpd -gqd >> /home/ubuntu/bagfiles/mounted.txt
...
/home/ubuntu/900RobotCode/zebROS_ws/ROSJetsonMaster.sh roslaunch controller_node 2024_compbot_combined.launch record:=true
