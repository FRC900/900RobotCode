...
#scp -P 22 ~/900RobotCode/scripts/RIO_setup/tflite_runtime-1.15.2-cp27-none-linux_armv7l.whl admin@$1:.
...
cd /home/ubuntu/wpilib/2025/roborio/arm-nilrt-linux-gnueabi/sysroot/usr/local/lib
...
#ssh -p 22 admin@$1 'opkg clean'
#scp -P 22 ~/900RobotCode/os_detect.py admin@$1:/usr/lib/python3.5/site-packages/rospkg/
...
ssh -p 22 admin@$1 'mkdir -p /home/ubuntu/wpilib/2025/roborio'
ssh -p 22 admin@$1 'ln -s / /home/ubuntu/wpilib/2025/roborio/arm-frc2024-linux-gnueabi'
ssh -p 22 admin@$1 'mkdir -p /home/ubuntu/wpilib/2025/roborio/arm-nilrt-linux-gnueabi'
ssh -p 22 admin@$1 'ln -s / /home/ubuntu/wpilib/2025/roborio/arm-nilrt-linux-gnueabi/sysroot'
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
##################-----------------------------#################
#Edit /etc/ntp.conf to be a copy of ntpClient in 900RobotCode#
#scp -P 22 ~/900RobotCode/scripts/RIO_setup/ntp.conf admin@$1:/etc/ntp.conf
...
# Set up ssh keys
scp -P 22 ~/900RobotCode/scripts/jetson_setup/roborio_dot_ssh.tar.bz2 admin@$1:.
...
scp -P 22 ~/900RobotCode/scripts/RIO_setup/rio_bashrc.sh admin@$1:.

# Set up prereqs for deploy script
ssh -p 22 admin@$1 'mv ~/900RobotCode ~/900RobotCode.orig'
