node {
    ...
    stage('Preparation') { 
      // Get some code from a GitHub repository
        ...
        sh 'docker pull frc900/zebros-2020-wpilib-beta-dev:latest'
   ...
   try {
       ...
       docker.image('frc900/zebros-2020-wpilib-beta-dev:latest').inside('--user root:root -v ' + env.WORKSPACE + ':/home/ubuntu/900RobotCode -l /bin/bash') { c ->
