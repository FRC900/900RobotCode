...
ang_vels = []
enableds = []
for topic, msg, t in rosbag.Bag(sys.argv[1]).read_messages(["/tagslam/odom/body_frc_robot", "/apriltag_detection_ov2311_10_9_0_9_video0/tags", "/apriltag_detection_ov2311_10_9_0_9_video1/tags", "/apriltag_detection_ov2311_10_9_0_10_video0/tags", "/apriltag_detection_ov2311_10_9_0_10_video1/tags", "/frcrobot_jetson/swerve_drive_controller/cmd_vel_out", "/frcrobot_rio/match_data"]):
    ...
    if topic == "/frcrobot_rio/match_data":
        enableds.append((t.to_sec(), 1 if msg.Enabled else 0))
