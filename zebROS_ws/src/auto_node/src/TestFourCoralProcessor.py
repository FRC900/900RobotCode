...
class TestFourCoralProcessor(AutoBase):
    def __init__(self) -> None:
        super().__init__(display_name="Test_2025_4_Coral_Processor_Side", # must match choreo path name
                         expected_trajectory_count=5) # how many segments of the path there are (split at waypoints)
