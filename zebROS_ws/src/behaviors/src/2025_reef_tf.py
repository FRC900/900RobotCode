...
from behavior_actions.msg import AutoAlignReef
import tf2_ros
...
def callback(msg: AutoAlignReef):
...
rospy.Subscriber('/align_to_reef/pipe', AutoAlignReef, callback) #subscribes to MatchSpecificData
rospy.spin()